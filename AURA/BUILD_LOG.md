...
- **Qwen3.8 Flash qua OpenRouter/Alibaba Cloud:** đọc một ảnh hóa đơn và trả dữ kiện theo JSON Schema chặt. Qwen không được quyền tự quyết định duyệt/chuyển tiếp.
...
- 51 automated tests gồm 47 policy/workflow test khóa precedence, e-commerce/mã vận chuyển, phạm vi MST theo loại chứng từ và các nhánh quyết định; 2 test hợp đồng OpenRouter/Qwen offline; 2 test toàn vẹn Test Kit/manifest.
...
- Prototype ban đầu dùng Gemini Free Tier; bản hiện tại dùng Qwen3.8 Flash trả phí qua OpenRouter để tránh phụ thuộc quota miễn phí.
...
Ba mươi fixture Test Kit v2 là dữ liệu tổng hợp sinh offline bằng script; không có hóa đơn cá nhân thật. Năm ảnh đại diện được dùng cho Verify. Ảnh upload được gửi qua OpenRouter tới Alibaba Cloud/Qwen, vì vậy AURA không tuyên bố on-premise hoặc zero-cloud.
