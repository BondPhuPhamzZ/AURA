...
|---|---|---|---|
| Qwen3-VL-4B-Instruct self-host | 4B tham số, open weights; phù hợp mục tiêu tài nguyên doanh nghiệp nhỏ | Cần GPU/runtime, giám sát, benchmark tiếng Việt và bảo mật vận hành; chưa có route OpenRouter ổn định được xác nhận trong catalog | Lộ trình sau demo, không giả lập bằng slug OpenRouter |
...
- Giai đoạn 2: benchmark Qwen3-VL-4B-Instruct self-host trên cùng 5 + 15 ca; đo latency P50/P95, VRAM, accuracy theo field và tỷ lệ escalation sai.
